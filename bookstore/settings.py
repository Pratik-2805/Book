...
# For local dev, allow a fallback; on Render the env var is set.
...
# Trust X-Forwarded-Proto from Render's proxy for secure URL generation
...
# Enable WhiteNoise in production on Render
